                ...
                <Container>
                    <Flex className="justify-between items-center">
                        <Flex className="items-center">
                            ...
                            <h1 className='ml-[10px]'>Shop by Category</h1>
                        </Flex>
                        <div className="">
                            <form action="post" method='post'>
                                <input className="bg-white py-[15px]  pr-[265px] placeholder:text-formtext placeholder:pl-[50px]" type="text" placeholder='Search Products' />
                                <button className='ml-[-40px]'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        ...
                        <div className="">
                            <Flex className="items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className='ml-[10px]' width="9" height="5" viewBox="0 0 9 5" fill="none">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className='ml-[50px]' width="18" height="16" viewBox="0 0 18 16" fill="none">
